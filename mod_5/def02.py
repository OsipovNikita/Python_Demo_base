...
def num(v):
    num.par += 1    # изменение атрибута 
    v.append('ten' + str(num.par))

print('Имя функции:', num.__name__) # атрибут - имя функции
print('Объект кода функции:', num.__code__) # атрибут - объект кода функции

num.par = 0 # атрибут функции - доступен как глобальная переменная
